...
### 2. Data collection
 ...
 [5] Acceptance rate / total number of Pull requests (insert image from slides/papers)
 [5] Persistence / acceptance rate (insert image from slides/papers)
 [9] Negative correlation between acceptance rate and time for response (insert image from slides/papers)
### 3. Data synthesis
